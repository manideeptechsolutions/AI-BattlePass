  ...
  return (
    <aside aria-label="Social Quick Connect" className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2.5">
      ...
      <a
        ...
        className="group flex items-center gap-2 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white p-3 rounded-2xl shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 hover:scale-105 transition-all duration-300"
      >
      ...
      <a
        ...
        className="group flex items-center gap-2 bg-[#25D366] text-white p-3.5 rounded-2xl shadow-lg shadow-emerald-600/30 hover:shadow-emerald-600/50 hover:scale-105 transition-all duration-300"
      >
